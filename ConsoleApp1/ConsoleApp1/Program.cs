    ...
    class Program
    {
        static void Main(string[] args)
        {
            static void ten()
            {
                ...
                Console.WriteLine("Нажми Enter для показа чисел");
                for (int i = 0; i < 10; i++)
                {
                    int x;
                ...
                Console.WriteLine("Нажми Enter для выхода в главное меню");
                Console.ReadLine();
            }
            static void city()
            {
            ...
            static void mil()
            {
                ...
                while (true)
                {
                    Console.WriteLine("Если хочешь продолжить введи 1, другое - выход в главное меню.");
                    int a = Int32.Parse(Console.ReadLine());
                    if (a == 1)
                    {
                        f();
